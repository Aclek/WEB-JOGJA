...
export default function Navbar() {
  ...
  useEffect(() => {
    // tambahkan event listener untuk menangani kapan navbar harus ditampilkan kembali
  ...
  // tambahkan useEffect untuk memantau perubahan lokasi
  useEffect(() => {
    setNavbarState(false); // atur navbarState menjadi false saat lokasi berubah
  }, [location]);
    ...
    <>
      ...
      <ResponsiveNav state={navbarState}>
        <ul>
          ...
          <li>
            <a href="#kuliner" onClick={() => setNavbarState(false)}>
              Kuliner
            </a>
          </li>
          <li>
